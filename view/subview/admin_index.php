...
<div class="content-box-header">
	...
	<ul class="content-box-tabs">
		<li><a href="#tab1" class="default-tab">Book list</a></li> <!-- href must be unique and match the id of target div -->
	</ul>
				...
				<tr>
					<td colspan="6">
						...
						<div class="pagination">
							...
							<a href="<?php echo BASE_URL ?>/admincp/#" class="number current" title="1">1</a>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<img class=book src="<?php echo BASE_URL ?>/content/images/<?php echo $value['img'] ?>">
						</td>
						<td>
							<!-- Icons -->
							<a href="<?php echo BASE_URL ?>/?controller=Admin&action=edit&book_id=<?php echo $value['book_id'] ?>" title="Edit">
